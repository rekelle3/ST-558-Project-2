...
available in the data set.
    ...
    ##  Mean   :2.50   Mean   :0.4868  
    ##  3rd Qu.:3.25   3rd Qu.:1.0000  
    ##  Max.   :4.00   Max.   :1.0000  
    ##       mnth         holiday           weekday 
    ##  Min.   : 1.0   Min.   :0.00000   Min.   :5  
    ##  1st Qu.: 4.0   1st Qu.:0.00000   1st Qu.:5  
    ##  Median : 6.0   Median :0.00000   Median :5  
    ##  Mean   : 6.5   Mean   :0.02632   Mean   :5  
    ##  3rd Qu.: 9.0   3rd Qu.:0.00000   3rd Qu.:5  
    ##  Max.   :12.0   Max.   :1.00000   Max.   :5  
    ##    workingday       weathersit   
    ##  Min.   :0.0000   Min.   :1.000  
    ##  1st Qu.:1.0000   1st Qu.:1.000  
    ##  Median :1.0000   Median :1.000  
    ##  Mean   :0.9737   Mean   :1.368  
    ##  3rd Qu.:1.0000   3rd Qu.:2.000  
    ##  Max.   :1.0000   Max.   :2.000  
    ##       temp            atemp       
    ##  Min.   :0.1609   Min.   :0.1578  
    ##  1st Qu.:0.3333   1st Qu.:0.3234  
    ##  Median :0.4446   Median :0.4277  
    ##  Mean   :0.4842   Mean   :0.4579  
    ##  3rd Qu.:0.6494   3rd Qu.:0.5999  
    ##  Max.   :0.8342   Max.   :0.7866  
    ##       hum           windspeed      
    ##  Min.   :0.3542   Min.   :0.05847  
    ##  1st Qu.:0.5251   1st Qu.:0.13775  
    ##  Median :0.5981   Median :0.17413  
    ##  Mean   :0.6047   Mean   :0.19013  
    ##  3rd Qu.:0.6911   3rd Qu.:0.23080  
    ##  Max.   :0.9725   Max.   :0.37811  
    ##       cnt      
    ##  Min.   :1421  
    ##  1st Qu.:3386  
    ##  Median :4597  
